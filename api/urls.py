...
urlpatterns = [
    ...
    path('categoryproduct/',views.CategoryProductView.as_view()),
    ...
    path('collectProduct/',views.CollectProductView.as_view()),
    ...
    path('waitauction/',views.WaitAuctionView.as_view()),
    path('haveauction/',views.HaveAuctionView.as_view()),
    path('dealdetail/',views.DealDetailView.as_view()),
    path('productdel/',views.ProductDelView.as_view()),
    path('newsdel/',views.NewsDelView.as_view()),
